...
const CONTACT_LINES={
 ...
 father:['투자도 좋지만 사람부터 잘 봐라. 학교 때 동아리 일 같은 건 두 번 겪지 말고.','예린이네하고 다시 연락한다는 소리 들었다. 친구든 전 연인이든 선부터 제대로 정해.','돈 잃은 건 다시 벌면 된다. 사람 문제 숨기다가 한꺼번에 터지는 게 더 무서운 거야.','이번 달은 어떠냐. 여자 문제든 돈 문제든 이번에는 사고 나기 전에 먼저 말해라.'],
...
root.QT_SOCIAL={ROLES,INDUSTRY_GATHERINGS,ensure,addContact,meet,gatheringStatus,attendIndustry,role,nurture,ask,monthly,legalShield,contactLine,contactAnswer,contactReplyOptions};
})(window);
