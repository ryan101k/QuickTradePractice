...
const LIFE_EVENTS = [
  {
    ...
    options: [
      { text: '상자와 세라를 집으로 데려와 함께 산다', effects: { cash:-120000, happy:1, morality:-4, meetSera:true, seraHousing:'cohabit' }, outcome: '낯선 사람을 충동적으로 집에 들인 선택이 선행이라고만 할 수는 없었습니다. 세라는 현관 가장 먼 곳에 상자를 두고 방 한쪽에 웅크렸습니다. 그날 밤 두 사람은 이름 외에는 거의 묻지 않았고, 같은 집에 있다는 사실만 불편하게 의식했습니다.' },
