/* =========================================================================
 *  QuickTrade Life — 사업·세력 운영 강점(APTITUDE)
 *
 *  플레이어는 6개 운영 축에 타고난 점수(0~100)를 갖는다.
 *  새 게임은 직업을 사용하지 않으며, 학창생활이 이 강점 분포를 보정한다.
 *  match/grow/performanceMul/riskMul은 구버전 저장·이벤트 호환용으로 남긴다.
 * ========================================================================= */
(function (root) {
  'use strict';
