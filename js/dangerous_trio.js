...
const CHAPTERS=[
 {
  ...
  desc:'유진은 신고 기록을, 채린은 안전한 거처를, 세라는 경쟁 세력의 송금책을 들고 왔습니다. 셋은 만나자마자 서로를 비정상이라 부르지만, 당신을 공격한 세력의 이름이 나오자 설명도 없이 수사·자금·정보 역할을 나눕니다.',
  speakers:[
   {name:'강유진',line:'세라 씨 방식은 불법이에요. 자료는 내가 증거로 바꿀 테니 원본은 건드리지 마요.'},
   {name:'한채린',line:'둘 다 느리네. 압류 전에 돈줄부터 묶을게. 경찰관은 영장, 세라는 우회 계좌를 줘.'},
 ...
 },
 {
  ...
  desc:'세 사람이 만든 집의 현관문은 열려 있습니다. 유진은 보호받는 당신의 안도한 표정을 좋아하고, 채린은 도움을 거절하지 못하는 순간을 즐기며, 세라는 돌아올 곳을 얻었습니다. 셋의 광기는 서로가 선을 넘지 못하게 견제할 때만 위협이 아닌 방패가 됩니다.',
  speakers:[
