...
const PRELUDES=[
 {
  ...
  desc:'세 사람 다 당신에게 마음이 기운 뒤였습니다. 유진은 참고인 안부라는 명분으로, 채린은 “지나가다 들렀다”는 핑계로, 세라는 늘 그렇듯 근처에 있었다며 — 서로의 존재는 전혀 모른 채 같은 날 같은 자리에 나타났습니다. 처음 마주친 셋은 인사도 제대로 못 하고, 상대가 왜 여기 있는지부터 눈으로 재기 시작합니다. 아직 싸움은 아니고, 그냥… 아주 어색합니다.',
  speakers:[
   {name:'강유진',line:'…경찰입니다. 두 분은 이분과 어떻게 되는 사이인지 여쭤도 될까요.'},
   {name:'한채린',line:'그쪽이야말로. 제복 입고 남의 집 앞을 지키는 게 요즘 경찰 일이에요?'},
   {name:'윤세라',line:'둘 다 오늘 처음 보는데… 왜 여기 있는지는 제가 더 궁금한데요.'},
   {name:'첫 부하',line:'보고드립니다. 세 분이 인사도 없이 서로 명함부터 요구하고 계십니다. 제가 낄 자리는 아닌 것 같습니다.'}
  ],
  choices:[
   {id:'divide_roles',text:'각자 온 이유만 짧게 확인하고 오늘은 돌려보낸다',stability:8,trust:3,result:'셋은 각자 온 이유만 대충 말하고 흩어졌습니다. 그러나 돌아가는 길 내내, 세 사람 모두 방금 본 나머지 둘의 얼굴을 오래 곱씹었습니다.'},
   {id:'ask_fault',text:'어색하니 서로 소개나 하라고 셋을 부추긴다',stability:-3,trust:1,result:'딱딱한 자기소개가 오갔지만 누구도 웃지 않았습니다. 대신 셋은 서로의 이름·직업, 그리고 당신을 부르는 방식까지 정확히 외워 버렸습니다.'},
   {id:'confiscate',text:'왜 다들 말도 없이 찾아왔냐고 셋 다 나무란다',stability:5,trust:2,result:'세 사람은 잔소리를 듣고도 물러서지 않았습니다. 오늘은 각자 돌아갔지만, 다음엔 먼저 온 사람이 유리하다는 걸 셋 다 알아 버렸습니다.'}
  ]
 },
 {
