...
const SPECIAL={
 ...
 '한채린':[
  {title:'잠기지 않은 개인실',min:18,scene:'event-chaerin-5.png',desc:'공개된 자리의 충돌 뒤 채린은 나래와 수행원까지 내보내고 개인실에 당신만 다시 부릅니다. 문은 닫되 잠그지 말라고 명령한 뒤, 정작 자신이 어디에 앉아야 하는지 당신에게 묻습니다. 밖에서 타인의 선택지를 좁히던 사람이 자기 욕망을 명령문 뒤에 숨기기 시작한 첫 장면입니다.',speaker:'거기 서 있어. 사과는 하지 말고. 그리고… 내가 뭘 해야 하는지 네가 말해. 착각하지 마, 내가 원해서 묻는 건 아니니까.',choices:[
