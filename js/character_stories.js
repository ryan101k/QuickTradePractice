...
const SPECIAL={
 ...
 '강유진':[
  {title:'동거인 확인서의 빈칸',min:18,scene:'event-yujin-rain-rescue.png',desc:'순찰 구역을 벗어나 당신의 귀가 시간을 확인했던 전화가 들킨 다음 날, 유진이 첫 방문 조사 기록의 수정본을 가져왔습니다. 윤세라의 거처와 사건 관계만 남기고, 수사와 무관한 생활 정보는 자기 손으로 지웠습니다. 업무용 확인을 사적인 관심에 사용했다는 사실을 변명하지 않고 처음 인정하는 자리입니다.',speaker:'보호하려면 알아야 한다고 생각했어요. 그런데 어젯밤에는 사건보다 내가 모르는 시간이 생기는 게 싫어서 전화했어요. 친구 번호를 수사처럼 쓰면 안 되는 거죠?',choices:[
 ...
 '한채린':[
  {title:'남겨 둔 종잇조각',min:18,scene:'event-chaerin-1.png',desc:'자기 하루를 대신 정하라며 내밀었던 법인카드 사건 뒤, 채린의 방에는 돌려받은 카드와 당신이 처음 찢었던 계약서 조각이 나란히 놓여 있습니다. 채린은 통제권을 통째로 넘기는 방식으로 관심을 확인하려 했다고 인정하면서도, 버리지 못한 조각의 의미만큼은 당신이 직접 물어보길 기다립니다.',speaker:'카드까지 돌려받고 나니까 이 조각도 그냥 실패한 계약이어야 하잖아. 그런데 못 버리겠어. 내가 또 시험을 만들기 전에, 이번에는 네가 뭘 묻고 싶은지 먼저 말해.',choices:[
