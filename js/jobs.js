...
const JOBS = [
  ...
  { id:'nurse',emoji:'🩺',name:'간호사',salary:3600000,risk:.075,dateBonus:16,difficulty:55,desc:'전문직 수입과 고강도 교대근무',incidents:[{text:'허리 부상으로 치료·휴직',cost:[500000,3000000]},{text:'감염 노출 후 자가격리',cost:[300000,1500000]}] },
  ...
  { id:'accountant',emoji:'🧾',name:'회계사',salary:5800000,risk:.08,dateBonus:20,difficulty:78,desc:'높은 전문성과 바쁜 결산 시즌',incidents:[{text:'검토 오류 관련 손해배상',cost:[2000000,12000000]},{text:'과로로 치료·휴직',cost:[800000,5000000]}] },
  { id:'lawyer',emoji:'⚖️',name:'변호사',salary:6500000,risk:.11,dateBonus:23,difficulty:88,desc:'고소득 전문직, 사건 수임 변동성',incidents:[{text:'수임 분쟁과 반환 소송',cost:[3000000,20000000]},{text:'사무실 운영비 적자',cost:[2000000,10000000]}] },
  ...
  { id:'realtor',emoji:'🏠',name:'공인중개사',salary:0,variable:[500000,10000000],risk:.13,dateBonus:14,difficulty:45,desc:'부동산 경기에 따라 수입이 크게 변동',incidents:[{text:'중개사고 손해배상',cost:[3000000,20000000]},{text:'거래절벽으로 사무실 적자',cost:[1500000,8000000]}] },
];
