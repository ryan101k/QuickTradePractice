...
ROMANCE_EVENTS.push(
 {id:'family_premarital_pregnancy',cat:'family',emoji:'🤰',title:'예상하지 못한 임신',desc:'결혼을 약속하기 전, 두 사람에게 임신 소식이 찾아왔습니다. 관계와 양육을 어떻게 책임질지 함께 결정해야 합니다.',cond:c=>c.rel==='dating'&&!c.familyPlan&&!c.dangerousTrioLiving&&Math.random()<.18,options:[
 ...
 {id:'family_affair_child',cat:'family',emoji:'🍼',title:'숨길 수 없는 소식',desc:'몰래 만나던 상대에게서 임신 소식이 왔습니다. 아이는 연애 관계와 별개의 책임이지만, 비밀은 현재 관계를 무너뜨릴 수 있습니다.',cond:c=>c.hasLovers&&!c.familyPlan&&!c.dangerousTrioLiving&&Math.random()<.24,options:[
