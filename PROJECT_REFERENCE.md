...
- 재접촉: 첫 상담 뒤에는 최초 사건 조건을 다시 요구하지 않는다. 개인 연락처가 열릴 때까지 인맥 창에 월 1회 후속 약속이 나타난다. 첫 만남에서 여지를 남기면 보통 한 번, 업무상 인사만 하면 두 번가량 더 만나야 한다.
- 개별 시스템: **구원 강박**
- 핵심 성향: 주인공이 무너지고 의존할수록 구조자 역할에 끌린다.
- 개인 스토리: 8장. `보호라는 감시 → 내부 비리 제보 → 반납한 위치추적기 → 새벽 두 시의 호출 → 나를 부르는 사람 → 증거 보관실의 새벽 → 제복을 벗은 사람 → 가장 먼저 부르는 이름`
...
윤세라와 동거 중 강유진·한채린의 후속 약속을 진행하면 세라가 귀가 시간과 약속 장소를 이미 알고 끼어드는 악우 변형이 나온다. 동거하지 않을 때도 두 사람의 후속 약속과 개인 연락처 해금은 정상 진행되며, 세라가 없는 단독 장면으로 바뀐다. 즉 세라 동거는 **3인 공동생활의 조건**이지 강유진·한채린 개인 루트의 진입 조건이 아니다.
