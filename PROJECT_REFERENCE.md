...
나래가 플레이어의 인생관을 설명하거나 시작 선택을 주도하지 않는다. 학창생활별 고정 친구가 투자지원센터를 알려 주며, 나래는 센터 담당자로서 처음 등장한다. 예린·보라·서연·나영·미래는 `생활경제연구회`의 옛 동료이자 주인공과 한 번씩 헤어진 전 연인들이다. 졸업 직전 모의투자 계정 조작 사건이 공통 과거 사건이며, 이들은 처음부터 친구나 연락 가능 인물로 열리지 않는다. 아버지·보호자는 이 사건을 기억해 주기적으로 경고 문자를 보낸다.
