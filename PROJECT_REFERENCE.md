...
사업 4인 밖의 연인이 한 명이라도 있으면 네 사람과 정식 연애를 시작할 수 없다. 네 명 중 누구와는 연애할 수 있지만 현재 연인은 한 명이다. 한 명과 사귀면 조건을 갖춘 나머지 책임자들이 심야 연락과 사업 견제로 자리를 빼앗으려 한다. 거절하면 현재 관계 안정도가 오르고 경쟁은 남는다. 받아들이면 일반 불륜 배드엔딩이 아니라 기존 책임자와 헤어지고 유혹한 책임자로 연인이 교체되며, 전 연인의 반격용 원한과 관계 긴장이 남는다.
