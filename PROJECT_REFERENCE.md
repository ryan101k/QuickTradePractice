...
다섯은 학창 시절 같은 동아리에서 주인공과 한 번씩 헤어진 전 연인들이며, 서로의 집·술버릇·이별 뒤 추한 모습까지 이미 전부 본 사이다. 공동 조사 중 지방 서버 보관소에서 원본 로그를 찾다가 막차가 끊겨 모텔 방 하나를 잡는 사건이 발생한다. 다섯은 입실 자체를 거리끼지 않지만, 주인공은 육체관계로 과거를 반복하는 선택을 거부해야 현재의 신뢰를 얻는다. 방을 함께 쓰되 선을 긋거나 로비에서 밤을 새우면 로그 속 발주 계좌가 경쟁 세력으로 이어져 세력전의 개인 목표가 생긴다. 분위기에 몸을 맡기면 회귀 압력이 크게 올라간다.

이 그룹이 현재 관계 중 가장 피폐한 축이다. 윤세라가 집 열쇠를 가진 채 등장하면 다섯은 열쇠 복사일·약 봉투·현관 사진·귀가 동선·도어록 기록을 즉시 합친다. 세라 한 명의 즉흥적인 집착보다, 오래된 연인 다섯이 질투하는 순간 하나의 기록망으로 움직이는 것이 더 위험하다.
